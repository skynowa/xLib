...
Test_Defines::unit()
{
    ...
    xTEST_CASE("xVA_...")
    {
        ...
        m_sRv = Format::str(xT("%s, %d"), csVal.c_str(), ciVal);
    ...
    xTEST_CASE("xPR_...")
    {
        // xPR_SIZET
        {
            ...
            m_sRv = Format::str(xT("%")xPR_SIZET, value);
        ...
        // xPR_I64d
        {
            ...
            m_sRv = Format::str(xT("%")xPR_I64d, value);
            xTEST_EQ(String::cast(value), m_sRv);
        }
        ...
        // xPR_I64u
        {
            ...
            m_sRv = Format::str(xT("%")xPR_I64u, value);
            xTEST_EQ(String::cast(value), m_sRv);
        }
        ...
        // xPR_I64x
        {
            ...
            m_sRv = Format::str(xT("%")xPR_I64x, value);
