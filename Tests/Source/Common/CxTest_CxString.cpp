...
)
{
    ...
    *****************************************************************************/
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        std::tostringstream_t osOut;   osOut << m_vsRes;
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        m_msRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key0"), xT("Value0")) );
        m_msRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key1"), xT("Value1")) );
        m_msRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key2"), xT("Value2")) );
        m_msRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key3"), xT("Value3")) );
        m_msRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key4"), xT("Value4")) );

        std::tostringstream_t osOut;   osOut << m_msRes;
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        m_mmsRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key0"), xT("Value0")) );
        m_mmsRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key1"), xT("Value1")) );
        m_mmsRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key2"), xT("Value2")) );
        m_mmsRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key0"), xT("Value0")) );
        m_mmsRes.insert( std::pair<std::tstring_t, std::tstring_t>(xT("Key1"), xT("Value1")) );

        std::tostringstream_t osOut;   osOut << m_mmsRes;
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("1")), m_sRes);
        ...
        xTEST_EQ(std::tstring_t(xT("0")), m_sRes);

        m_sRes = CxString::lexical_cast(- 5);
        xTEST_EQ(std::tstring_t(xT("-5")), m_sRes);
    ...
    xTEST_CASE(cullCaseLoops)
    {
        m_sRes = CxString::lexical_cast<std::tstring_t>(xT("String"));
        xTEST_EQ(std::tstring_t(xT("String")), m_sRes);

        m_iRes = CxString::lexical_cast<int>(xT("7"));
        xTEST_EQ(7, m_iRes);

        m_ulRes = CxString::lexical_cast<ulong_t>(xT("123"));
        xTEST_EQ(123UL, m_ulRes);

        m_ullRes = CxString::lexical_cast<ulonglong_t>(xT("123"));
        ...
        ////m_uiRes = CxString::lexical_cast<size_t>( std::tstring_t() );
        ////xTEST_EQ(0U, m_uiRes);
    }
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("2011")), m_sRes);

        m_sRes = CxString::lexical_cast(1033, 10);
        xTEST_EQ(std::tstring_t(xT("1033")), m_sRes);

        m_sRes = CxString::lexical_cast(1033, 16);
        xTEST_EQ(std::tstring_t(xT("409")), m_sRes);
    }

    xTEST_CASE(cullCaseLoops)
    {
        ////m_sRes = CxString::sIntToStr(1033L, 2);
        ////xTEST_EQ(std::tstring_t(xT("10000001001")), m_sRes);
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        for (size_t b = 0; b < xARRAY_SIZE(caiBases); ++ b) {
            for (size_t i = 0; i < xARRAY_SIZE(casData); ++ i) {
                const std::tstring_t sRes    = casData[i];

                const std::tstring_t sHexStr = CxString::lexical_cast(sRes, caiBases[b]);
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("true")), m_sRes);

        m_sRes = CxString::sBoolToStr(false);
        xTEST_EQ(std::tstring_t(xT("false")), m_sRes);
    } 
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("TEST_STRING_1")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("TEST_STRING_1"), xT("T"), xT("a"));
        xTEST_EQ(std::tstring_t(xT("aESa_SaRING_1")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("D:/XVCL/Include\\XVCL/Units/Gui/vSpeedButton_LoadDrives.cpp"), xT("/"), xT("_"));
        xTEST_EQ(std::tstring_t(xT("D:_XVCL_Include\\XVCL_Units_Gui_vSpeedButton_LoadDrives.cpp")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("D:/XVCL/Include\\XVCL/Units/Gui/vSpeedButton_LoadDrives.cpp"), xT("\\"), xT("_"));
        xTEST_EQ(std::tstring_t(xT("D:/XVCL/Include_XVCL/Units/Gui/vSpeedButton_LoadDrives.cpp")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("_one_two_three_"), xT("two"), xT(""));
        xTEST_EQ(std::tstring_t(xT("_one__three_")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("_one_two_three_"), xT("two"), xT("fife"));
        xTEST_EQ(std::tstring_t(xT("_one_fife_three_")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("_one_two_three_"), xT("two"), xT("^"));
        xTEST_EQ(std::tstring_t(xT("_one_^_three_")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("aaaaffaaaa"), xT("ff"), xT("ffff"));
        xTEST_EQ(std::tstring_t(xT("aaaaffffaaaa")), m_sRes);

        m_sRes = CxString::sReplaceAll(xT("aaaaffaaaa"), xT("ff"), xT("f"));
        xTEST_EQ(std::tstring_t(xT("aaaafaaaa")), m_sRes);
    }
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(m_sRes, std::tstring_t(xT("_one_test_string_")));

        m_sRes = CxString::sReplaceAll(xT(" one test string "), xT(" "), xT(""));
        xTEST_EQ(m_sRes, std::tstring_t(xT("oneteststring")));

        m_sRes = CxString::sReplaceAll(xT(" one test string "), xT(' '), xT('-'));
        xTEST_EQ(m_sRes, std::tstring_t(xT("-one-test-string-")));
    }
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("oneteststring")), m_sRes);
        ...
        xTEST_EQ(std::tstring_t(xT(" one test  ")), m_sRes);

        m_sRes = CxString::sRemoveAll(xT(" one test string "), xT("string"));
        xTEST_EQ(std::tstring_t(xT(" one test  ")), m_sRes);

        m_sRes = CxString::sRemoveAll(xT("one test stringg"),  xT("string"));
        xTEST_EQ(std::tstring_t(xT("one test g")), m_sRes);
    }
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("111--222-333")), m_sRes);
    }
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("_Alca@meta.ua_")), m_sRes);
        ...
        m_sRes = CxString::sCut(sForCut, xT("<"), xT(">"));
        xTEST_EQ(std::tstring_t(xT("_Alc<a>@meta>.ua_")), m_sRes);
        ...
        sForCut = xT("To: =?windows-125<<_Alc<<a>>@meta>>.ua_>1?B?x+Di4+7w7uTt//8=?= ");
        m_sRes = CxString::sCut(sForCut, xT("<<"), xT(">>"));
        xTEST_EQ(std::tstring_t(xT("_Alc<<a>>@meta")), m_sRes);
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("012345678")), m_sRes);

        m_sRes = CxString::sCut(sForCut, 4, 5);
        xTEST_EQ(std::tstring_t(xT("4")), m_sRes);

        m_sRes = CxString::sCut(sForCut, 4, 6);
        xTEST_EQ(std::tstring_t(xT("45")), m_sRes);
        ...
        xTEST_EQ(std::tstring_t(xT("0123456789")), m_sRes);

        m_sRes = CxString::sCut(sForCut, 4);
        xTEST_EQ(std::tstring_t(xT("456789")), m_sRes);

        m_sRes = CxString::sCut(sForCut, 9);
        xTEST_EQ(std::tstring_t(xT("9")), m_sRes);
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        //various string size
        {
            for (size_t i = 1; i < 1024 * 2; ++ i) {
                ...
                std::tstring_t m_sRes = CxString::sFormat(xT("%s"), _sData.c_str());
    ...
    xTEST_CASE(cullCaseLoops)
    {
        ...
        xTEST_EQ(std::tstring_t(xT("55...")), m_sRes);

        m_sRes = CxString::sMinimize(xT("55555wwwww00000"), 20);
        xTEST_EQ(std::tstring_t(xT("55555wwwww00000")), m_sRes);
    }
    ...
    *****************************************************************************/
    ...
    //sDecodeWinKoi
    xTEST_CASE(cullCaseLoops) {
        //m_sRes = sDecodeWinKoi(int iFrom, int iTo, const std::tstring_t &sOldStr);
    }
    ...
    xTEST_CASE(cullCaseLoops)
    {
            ...
            xTEST_EQ(std::tstring_t(xT("ConsoleTest.exe': Loaded 'C:\\Program Files\\Kaspersky Lab\\Kaspersky Internet Security 2009\\adialhk.dll")), m_sRes);
        #endif
    }
    ...
    //sStrToRtf
    xTEST_CASE(cullCaseLoops) {
        //m_sRes = CxString::sStrToRtf(std::tstring_t sStr);
    }

    //-------------------------------------
    //sRtfToStr
    xTEST_CASE(cullCaseLoops) {
        //m_sRes = CxString::sRtfToStr(std::tstring_t sStr);
    }
    ...
    #if xTODO
        for (int i = 0; i <= 120; ++ i) {
            std::tstring_t sRes = sColorStr(xT("Linux Console Color"), (EForeground)i, false, false, bgBlack, false);
            std::cout<< xT("Color: ") << i << xT(" ") << sRes << std::endl;
        }

        std::tstring_t sRes = CxString::sFormatNixTerminal(xT("Linux Console Color"), CxString::fgYellow_, true, false, CxString::bgBlue_, false);
    ...
    *****************************************************************************/
    ...
    xTEST_CASE(cullCaseLoops)
    {
        std::tstring_t sRes;
            ...
            xTEST_EQ(std::tstring_t(xT("1111, hdbhjgjk hkl, jl.,kh.")), sRes);
        #elif xOS_ENV_UNIX
            //TODO: sOemToCharBuff
        #endif
    }
