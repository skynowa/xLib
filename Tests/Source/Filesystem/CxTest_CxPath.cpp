...
)
{
    ...
    std::vector<std::string_t> vsRes;
        ...
        const std::string_t csFilePathSt  = xT("/home/user/Soft/Test_Static.txt");
        const std::string_t csFileName    = xT("TestName");
        const std::string_t csFileExt     = xT("doc");
    #endif
    ...
    *****************************************************************************/
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sGetDir(sData[i][0]);
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sGetDirName(sData[i][0]);
            std::string_t sStr2 = sData[i][1];
            xTEST_EQ(sStr1, sStr2);
        }
    }
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sGetFullName(sData[i][0]);
            std::string_t sStr2 = sData[i][1];
            xTEST_EQ(sStr1, sStr2);
        }
    }
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sGetName(sData[i][0]);
            std::string_t sStr2 = sData[i][1];
            xTEST_EQ(sStr1, sStr2);
        }
    }
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sGetExt(sData[i][0]);
            std::string_t sStr2 = sData[i][1];
            xTEST_EQ(sStr1, sStr2);
        }
    }
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
            ...
            for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
                std::string_t sStr1 = CxPath::sSetDrive(sData[i][0], sData[i][1]);
                std::string_t sStr2 = CxPath::sSetDrive(sData[i][2], sData[i][1]);
                xTEST_EQ(sStr1, sStr2);

                std::string_t sStr3 = CxPath::sSetDrive(sData[i][0], sData[i][1]);
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sRemoveExt(sData[i][0]);
            std::string_t sStr2 = sData[i][1];
            xTEST_EQ(sStr1, sStr2);
        }
    }
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sTestData); ++ i) {
            std::string_t sStr1 = CxPath::sSetValidName(sTestData[i][0]);
            std::string_t sStr2 = CxPath::sSetValidName(sTestData[i][1]);
            xTEST_EQ(sStr1, sStr2);

            std::string_t sStr3 = CxPath::sSetValidName(sTestData[i][0]);
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sMinimizeName(sData[i][0], 4);
            std::string_t sStr2 = sData[i][1];
            xTEST_EQ(sStr1, sStr2);
        }
    }
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sSlashAppend(sData[i][0]);
            std::string_t sStr2 = CxPath::sSlashAppend(sData[i][1]);
            xTEST_EQ(sStr1, sStr2);

            std::string_t sStr3 = CxPath::sSlashAppend(sData[i][0]);
    ...
    xTEST_BLOCK(cullBlockLoops)
    {
        ...
        for (size_t i = 0; i < xARRAY_SIZE(sData); ++ i) {
            std::string_t sStr1 = CxPath::sSlashRemove(sData[i][0]);
            std::string_t sStr2 = CxPath::sSlashRemove(sData[i][1]);
            xTEST_EQ(sStr1, sStr2);

            std::string_t sStr3 = CxPath::sSlashRemove(sData[i][0]);
            std::string_t sStr4 = sData[i][1];
            xTEST_EQ(sStr3, sStr3);
        }
    }
