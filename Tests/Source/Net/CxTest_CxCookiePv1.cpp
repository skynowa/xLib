...
{
    const std::string_t   csName      = xT("Name1");
    const std::string_t   csValue     = xT("Value1");
    const std::string_t   csComment   = xT("Comment1");
    const std::string_t   csDomain    = xT(".domain.com1");
    const std::string_t   csPath      = xT("/1");
    ...
    //--------------------------------------------------
    //CxCookiePv1(const std::string_t &);
    xTEST_BLOCK(cullBlockLoops)
    {
