...
{
    xTEST_CASE("Console::setAttributes", a_caseLoops)
    {
        Console console;
    ...
    xTEST_CASE("Console::read", a_caseLoops)
    {
        #if xTEST_IGNORE
            Console console;
    ...
    xTEST_CASE("Console::write", a_caseLoops)
    {
        #if xTEST_IGNORE
    ...
    xTEST_CASE("Console::writeLine", a_caseLoops)
    {
        #if xTEST_IGNORE
    ...
    xTEST_CASE("Console::msgBox", a_caseLoops)
    {
        #if xTEST_IGNORE
    ...
    xTEST_CASE("Console::prompt", a_caseLoops)
    {
        #if xTEST_IGNORE
    ...
    xTEST_CASE("Console::pause", a_caseLoops)
    {
        #if xTEST_IGNORE
            Console console;
    ...
    xTEST_CASE("Console::clear", a_caseLoops)
    {
        #if xTEST_IGNORE
            Console console;
    ...
    xTEST_CASE("Console::setTitle", a_caseLoops)
    {
        #if xTEST_IGNORE
    ...
    xTEST_CASE("Console::title", a_caseLoops)
    {
...
#if xENV_WIN && xTEST_IGNORE
    xTEST_CASE("Console::centerWindow", a_caseLoops)
    {
        Console console;
...
#if xENV_WIN && xTEST_IGNORE
    xTEST_CASE("Console::setFullScreen", a_caseLoops)
    {
        Console console;
...
#if xENV_WIN && xTEST_IGNORE
    xTEST_CASE("Console::enableClose", a_caseLoops)
    {
        Console console;
