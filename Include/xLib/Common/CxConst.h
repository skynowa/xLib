    ...
    /// constants
{
    public:
        ...
        static const std::tstring_t xSTR_EMPTY;
        ...
        static const std::tstring_t xCR;
        ...
        static const std::wstring xNL_W;
            ///< newline (unicode)
        static const std::tstring_t xNL;
        ...
        static const std::tstring_t  xCRNL;
        ...
        static const std::wstring xCOLON_W;
            ///< colon (unicode)
        static const std::tstring_t xCOLON;
        ...
        static const std::tstring_t xWIN_SLASH;
        ...
        static const std::tstring_t xNIX_SLASH;
        ...
        static const std::tstring_t xSLASH;
        ...
        static const std::wstring xEOL_W;
            ///< end of line (unicode)
        static const std::tstring_t xEOL;
        ...
        static const std::tstring_t xDRIVE_SEP;
        ...
        static const std::tstring_t xSEMICOLON;
        ...
        static const std::wstring xDOT_W;
            ///< 1 dot (unicode)
        static const std::tstring_t xDOT;
        ...
        static const std::wstring x2DOT_W;
            ///< 2 dots (unicode)
        static const std::tstring_t x2DOT;
            ///< 2 dots
        ...
        static const std::wstring xMASK_ALL_W;
            ///< all files mask (unicode)
        static const std::tstring_t xMASK_ALL;
            ///< all files mask (ansi or unicode)
        ...
        static const std::tstring_t xHT;
        ...
        static const std::tstring_t xVT;
        ...
        static const std::wstring xSPACE_W;
            ///< space (unicode)
        static const std::tstring_t xSPACE;
        ...
        static const std::wstring xBELL_W;
            ///< alert (unicode)
        static const std::tstring_t xBELL;
        ...
        static const std::wstring xBS_W;
            ///< backspace (unicode)
        static const std::tstring_t xBS;
        ...
        static const std::wstring xFF_W;
            ///< formfeed (unicode)
        static const std::tstring_t xFF;
        ...
        static const std::tstring_t xQM;
        ...
        static const std::tstring_t xSQM;
        ...
        static const std::tstring_t xDQM;
        ...
        static const std::tstring_t xWHITE_SPACES;
        ...
        static const std::wstring xEQUAL_W;
            ///< equal sign (unicode)
        static const std::tstring_t xEQUAL;
        ...
        static const std::wstring xHYPHEN_W;
            ///< hyphen (unicode)
        static const std::tstring_t xHYPHEN;
            ...
            static const std::wstring xXXXXX_W;
                ///< xxxxx (unicode)
            static const std::tstring_t xXXXXX;
