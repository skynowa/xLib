...
//-------------------------------------------------------------------------------------------------
inline bool_t
CxDateTime::Validator::dateOrTime(
    cint_t &a_year,
    cint_t &a_month,
    cint_t &a_day,
    cint_t &a_hour,
