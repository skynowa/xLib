...
bool_t operator == (const Array<T, N> &x, const Array<T, N> &y)
{
...
// swap()
template<class T, std::size_t N>
inline void_t swap(Array<T, N> &x, Array<T, N> &y)
{
    x.swap(y);
}
//-------------------------------------------------------------------------------------------------
