...
using data1_ssize_t     =  Data1<std::ssize_t>;
using data1_size_t      =  Data1<std::size_t>;
...
using data2_ssize_t     = Data2<std::tstring_t, std::ssize_t>;
using data2_size_t      = Data2<std::tstring_t, std::size_t>;
...
using data3_ssize_t     = Data3<std::tstring_t, std::tstring_t, std::ssize_t>;
using data3_size_t      = Data3<std::tstring_t, std::tstring_t, std::size_t>;
