...
#define xLib_xTestH
//-------------------------------------------------------------------------------------------------
#define _xTEST_MSG_EQ(reportType, val1, val2, msg)      { if ( !((val1) == (val2)) ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT(#val1),   xT(#val2), (val1),        (val2),         xT("=="), _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_DIFF(reportType, val1, val2, msg)    { if ( !((val1) != (val2)) ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT(#val1),   xT(#val2), (val1),        (val2),         xT("!="), _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_LESS(reportType, val1, val2, msg)    { if ( !((val1) <  (val2)) ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT(#val1),   xT(#val2), (val1),        (val2),         xT("<"),  _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_GR(reportType, val1, val2, msg)      { if ( !((val1) >  (val2)) ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT(#val1),   xT(#val2), (val1),        (val2),         xT(">"),  _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_LESS_EQ(reportType, val1, val2, msg) { if ( !((val1) <= (val2)) ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT(#val1),   xT(#val2), (val1),        (val2),         xT("<="), _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_GR_EQ(reportType, val1, val2, msg)   { if ( !((val1) >= (val2)) ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT(#val1),   xT(#val2), (val1),        (val2),         xT(">="), _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_PTR(reportType, ptr, msg)            { if ( NULL     == (ptr)   ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT("NULL"),  xT(#ptr),  (intptr_t)ptr, (intptr_t)NULL, xT("!="), _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_PTR_FAIL(reportType, ptr, msg)       { if ( NULL     != (ptr)   ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT("NULL"),  xT(#ptr),  (intptr_t)ptr, (intptr_t)NULL, xT("=="), _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
#define _xTEST_MSG_FAIL(reportType, msg)                { if ( true                ) { ulong_t _lastError = CxLastError::get(); CxErrorReport report(reportType, xT("false"), xT(""),    xT(""),        xT(""),         xT(""),   _lastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().toString(), (msg));  CxDebugger().reportMake(report); } }
