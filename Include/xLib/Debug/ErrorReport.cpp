...
ErrorReport::_initPlain()
{
    ...
    ossRv
        ...
        << margin << xT("File size:     ") << _fileSize       << "\n"
                                                              << "\n"
        << margin << xT("Source file:   ") << Path( Path(_sourceInfo.file()).brief(::reportWidthMax) ).toUnix(false)  << "\n"
        << margin << xT("Source line:   ") << _sourceInfo.line()     << "\n"
        << margin << xT("Function name: ") << _sourceInfo.func()   << "\n"
