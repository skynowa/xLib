...
//---------------------------------------------------------------------------
    ...
    #define xASSERT_EQ(expr1, expr2)                        { if ( !((expr1) == (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("=="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_DIFF(expr1, expr2)                      { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS(expr1, expr2)                      { if ( !((expr1) <  (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER(expr1, expr2)                   { if ( !((expr1) >  (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS_EQ(expr1, expr2)                   { if ( !((expr1) <= (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER_EQ(expr1, expr2)                { if ( !((expr1) >= (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtMsgboxPlain, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_EQ(expr1, expr2)                        { if ( !((expr1) == (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("=="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_DIFF(expr1, expr2)                      { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS(expr1, expr2)                      { if ( !((expr1) <  (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER(expr1, expr2)                   { if ( !((expr1) >  (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS_EQ(expr1, expr2)                   { if ( !((expr1) <= (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER_EQ(expr1, expr2)                { if ( !((expr1) >= (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtMsgboxFormated, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_EQ(expr1, expr2)                        { if ( !((expr1) == (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("=="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_DIFF(expr1, expr2)                      { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS(expr1, expr2)                      { if ( !((expr1) <  (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER(expr1, expr2)                   { if ( !((expr1) >  (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS_EQ(expr1, expr2)                   { if ( !((expr1) <= (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER_EQ(expr1, expr2)                { if ( !((expr1) >= (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtStdoutPlain, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_EQ(expr1, expr2)                        { if ( !((expr1) == (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("=="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_DIFF(expr1, expr2)                      { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS(expr1, expr2)                      { if ( !((expr1) <  (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER(expr1, expr2)                   { if ( !((expr1) >  (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS_EQ(expr1, expr2)                   { if ( !((expr1) <= (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER_EQ(expr1, expr2)                { if ( !((expr1) >= (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtStdoutHtml, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_EQ(expr1, expr2)                        { if ( !((expr1) == (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("=="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_DIFF(expr1, expr2)                      { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS(expr1, expr2)                      { if ( !((expr1) <  (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER(expr1, expr2)                   { if ( !((expr1) >  (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS_EQ(expr1, expr2)                   { if ( !((expr1) <= (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER_EQ(expr1, expr2)                { if ( !((expr1) >= (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtLoggingPlain, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_EQ(expr1, expr2)                        { if ( !((expr1) == (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("=="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_DIFF(expr1, expr2)                      { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS(expr1, expr2)                      { if ( !((expr1) <  (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER(expr1, expr2)                   { if ( !((expr1) >  (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">"),  CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_LESS_EQ(expr1, expr2)                   { if ( !((expr1) <= (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("<="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_GREATER_EQ(expr1, expr2)                { if ( !((expr1) >= (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT(">="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtLoggingHtml, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_DIFF(expr1, expr2)                      { /* n/a */ }
