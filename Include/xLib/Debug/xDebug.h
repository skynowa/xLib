...
//---------------------------------------------------------------------------
    ...
    #define xASSERT_PTR(ptr)                                { if ( (NULL)    == (ptr)    )  { CxReport rpReport(CxReport::rtMsgboxRtf, (intptr_t)ptr, (intptr_t)NULL, xT("NULL"), xT(#ptr),   xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, xT(""));  CxDebugger::bReportMake(rpReport); } }
