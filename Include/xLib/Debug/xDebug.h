...
//---------------------------------------------------------------------------
    ...
    #define xASSERT_NOT_EQ(expr1, expr2)                    { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_NOT_EQ(expr1, expr2)                    { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtMsgboxFormated, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_NOT_EQ(expr1, expr2)                    { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtStdoutPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_NOT_EQ(expr1, expr2)                    { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtStdoutHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_NOT_EQ(expr1, expr2)                    { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtLoggingPlain, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
    ...
    #define xASSERT_NOT_EQ(expr1, expr2)                    { if ( !((expr1) != (expr2)) )  { CxReport rpReport(CxReport::rtLoggingHtml, expr1,         expr2,          xT(#expr1), xT(#expr2), xT("!="), CxLastError::ulGet(), xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), xT(""));  CxDebugger::bReportMake(rpReport); } }
