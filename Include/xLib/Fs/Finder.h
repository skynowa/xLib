...
xPUBLIC_STATIC:
    ...
    static void_t         files(std::ctstring_t &rootDirPath, std::ctstring_t &shellFilter,
        ...
        ///< search files
    static std::tstring_t file(std::cvec_tstring_t &rootDirPaths, std::ctstring_t &shellFilter,
                              cbool_t isRecursively);
        ///< search file in directories (by priority)
    static std::tstring_t fileInEnvPath(std::ctstring_t &shellFilter, cbool_t isRecursively);
