    ...
    /// GDI+ image
{
    public:
        ...
        bool            bLoad            (const std::tstring_t &csFilePath);
            ///< load
        bool            bLoad            (IStream *pisStream);
            ///< load
        bool            bSave            (const std::tstring_t &csFilePath, EEncoderType etType);
            ///< save
    ...
    private:
        ...
        bool            _bGetEncoderClsid(const std::tstring_t &csFormat, CLSID *pcidClsid);
            ///< get encoder clsid
};
