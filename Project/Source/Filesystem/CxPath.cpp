...
CxPath::sGetExe() {
    ...
    /*DEBUG*/xASSERT_RET(true == CxFile::bIsExists(sRv), std::tstring_t());
...
)
{
    ...
    /*DEBUG*/xASSERT_RET(0UL != ulRv, std::tstring_t());
    ...
    /*DEBUG*/xASSERT_RET(false != bIsAbsolute(sRv), std::tstring_t());
