 ...
 *
 *     bRv = bGetUsbInfo(xT("H:\\"), &vsRes);
 *     xTEST_EQ(std::tstring_t(xT("\\??\\USB")),                              vsRes.at(0));
 *     xTEST_EQ(std::tstring_t(xT("Vid_058f&Pid_6387")),                      vsRes.at(1));
 *     xTEST_EQ(std::tstring_t(xT("3DH5R5EL")),                               vsRes.at(2));
 *     xTEST_EQ(std::tstring_t(xT("{a5dcbf10-6530-11d2-901f-00c04fb951ed}")), vsRes.at(3));
 *
