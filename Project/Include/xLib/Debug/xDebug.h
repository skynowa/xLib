...
//---------------------------------------------------------------------------
#define _xTEST_MSG_EQ(report_type, val1, val2, msg)      { if ( !((val1) == (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, (val1),        (val2),         xT(#val1),   xT(#val2), xT("=="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_DIFF(report_type, val1, val2, msg)    { if ( !((val1) != (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, (val1),        (val2),         xT(#val1),   xT(#val2), xT("!="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_LESS(report_type, val1, val2, msg)    { if ( !((val1) <  (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, (val1),        (val2),         xT(#val1),   xT(#val2), xT("<"),  ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_GR(report_type, val1, val2, msg)      { if ( !((val1) >  (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, (val1),        (val2),         xT(#val1),   xT(#val2), xT(">"),  ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_LESS_EQ(report_type, val1, val2, msg) { if ( !((val1) <= (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, (val1),        (val2),         xT(#val1),   xT(#val2), xT("<="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_GR_EQ(report_type, val1, val2, msg)   { if ( !((val1) >= (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, (val1),        (val2),         xT(#val1),   xT(#val2), xT(">="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
