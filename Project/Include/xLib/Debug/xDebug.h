...
//---------------------------------------------------------------------------
#define _xTEST_MSG_EQ(report_type, val1, val2, msg)      { if ( !((val1) == (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT(#val1),   xT(#val2), (val1),        (val2),         xT("=="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_DIFF(report_type, val1, val2, msg)    { if ( !((val1) != (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT(#val1),   xT(#val2), (val1),        (val2),         xT("!="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_LESS(report_type, val1, val2, msg)    { if ( !((val1) <  (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT(#val1),   xT(#val2), (val1),        (val2),         xT("<"),  ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_GR(report_type, val1, val2, msg)      { if ( !((val1) >  (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT(#val1),   xT(#val2), (val1),        (val2),         xT(">"),  ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_LESS_EQ(report_type, val1, val2, msg) { if ( !((val1) <= (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT(#val1),   xT(#val2), (val1),        (val2),         xT("<="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_GR_EQ(report_type, val1, val2, msg)   { if ( !((val1) >= (val2)) ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT(#val1),   xT(#val2), (val1),        (val2),         xT(">="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_PTR(report_type, ptr, msg)            { if ( NULL     == (ptr)   ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT("NULL"),  xT(#ptr),  (intptr_t)ptr, (intptr_t)NULL, xT("!="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_PTR_FAIL(report_type, ptr, msg)       { if ( NULL     != (ptr)   ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT("NULL"),  xT(#ptr),  (intptr_t)ptr, (intptr_t)NULL, xT("=="), ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
#define _xTEST_MSG_FAIL(report_type, msg)                { if ( true                ) { ulong_t ulLastError = CxLastError::ulGet(); CxErrorReport rpReport(report_type, xT("false"), xT(""),    xT(""),        xT(""),         xT(""),   ulLastError, xFILE, xLINE, xFUNCTION, xDATE, xTIME, CxStackTrace().sGet(), (msg));  CxDebugger().vReportMake(rpReport); } }
