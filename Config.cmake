...
if (IS_PARENT_SCOPE)
    ...
    set(xOPTION_DEBUG_MODE_EXCEPTION  ON  CACHE BOOL "Debug mode: exception" FORCE PARENT_SCOPE)
    ...
    set(xOPTION_DEBUG_MODE_EXCEPTION  ON  CACHE BOOL "Debug mode: exception" FORCE)
